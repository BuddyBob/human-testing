...
export default function Memory(){
  ...
  async function lightUp(){
    ...
    for (let i = 0; i < problemSet.length; i++){
      ...
      await document.getElementsByClassName("cell"+problemSet[i])[0].classList.remove('light')
      await document.getElementsByClassName("cell"+problemSet[i])[0].classList.add('dim')
      console.log("hello")

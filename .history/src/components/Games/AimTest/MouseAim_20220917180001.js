...
function MouseAim() {
    ...
    async function targetClicked(){
        ...
        console.log(JSON.parse(localStorage.getItem('games')).reflex.times.length)
        if (JSON.parse(localStorage.getItem('games')).reflex.times.length === 10){
            console.log("10 items clicked")
            setStart(false)
            setTimerStarted(false)
            setTarget(false)
            setTime(0)
            localStorage.setItem('games', JSON.stringify(JSON.parse(localStorage.getItem('games')).reflex.times.clear()))
        }

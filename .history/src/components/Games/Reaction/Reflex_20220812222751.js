    ...
    return (
        <div>
            <div className="main-container">
                ...
                {click? console.log(time.toFixed(2)) : null}
                {
                    startGame ? 
                        <>
                            { click ? 
                                <input type="button" onClick={()=>console.log(time.toFixed(2))} className="reflex-button" style={{background: '#48b153', border: '#48b153 solid 2px'}} value="Click!"/> 

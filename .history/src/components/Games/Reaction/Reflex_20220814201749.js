...
export default function Reflex() {
    ...
    function handleStop(){
        ...
        setPrevTime(time)
        setTimer(0)
        console.log(JSON.parse(localStorage.getItem('games')).reflex.times)
        ...
        <div>
            <div className="main-container">
                ...
                <div className="num-stats">
                        <p className="avg">
                            <strong>Average:</strong> {JSON.parse(localStorage.getItem('games')).reflex.average}
                        </p>
                        <p>
                            <strong>Best Time:</strong> {_.min(JSON.parse(localStorage.getItem('games')).reflex.times)}
                        </p>
                        <p>
                            <strong>Worst Time:</strong> {_.max(JSON.parse(localStorage.getItem('games')).reflex.times)}
                        </p>
                </div>
            </div>
        </div>
